      ...
      <div className="p-3 bg-gray-50 border rounded-md">
        ...
        <div className="mt-2 space-y-1 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium text-primary">{workingDays} hari</span>
          </div>
        </div>
      </div>

      {/* Explanation of leave calculation */}
      <Alert className="bg-blue-50 border-blue-200">
        <Info className="h-4 w-4 text-blue-500" />
        <AlertTitle className="text-blue-700">Informasi Perhitungan Cuti</AlertTitle>
        <AlertDescription className="text-blue-600">
          <p>Sistem secara otomatis tidak menghitung:</p>
          <ul className="list-disc pl-5 mt-1">
            <li>Hari Sabtu dan Minggu</li>
            <li>Hari libur nasional</li>
          </ul>
          <p className="mt-1">Hanya hari kerja yang akan mengurangi saldo cuti Anda.</p>
        </AlertDescription>
      </Alert>
